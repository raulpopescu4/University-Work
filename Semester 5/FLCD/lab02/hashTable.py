...
class HashTable:
    ...
    def search(self, element):
        ...
        for index, value in enumerate(row):
            if value == element:
                searched_position = Pair(row_number, index)
                break
    ...
    def add(self, element):
        ...
        element_position = Pair(row_number, index)
    ...
    def remove(self, element):
        ...
        if element_position.valid():
            self.table[element_position.key].remove(element)
        else:
