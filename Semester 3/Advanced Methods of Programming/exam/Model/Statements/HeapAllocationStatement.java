...
public class HeapAllocationStatement implements iStatement {
    ...
    public ProgramState execute(ProgramState state) throws MyException {
        ...
        if (!currentSymbolTable.isDefined(this.variableName))
            throw new MyException("Variable " + this.variableName + " is not defined in the symbols table!");

        Value variable = currentSymbolTable.lookUp(this.variableName);
        ...
        Value valueOfExpression = this.expression.evaluate(currentSymbolTable, heapTable);
        ...
        currentSymbolTable.add(this.variableName, new ReferenceValue(address, locationType));
