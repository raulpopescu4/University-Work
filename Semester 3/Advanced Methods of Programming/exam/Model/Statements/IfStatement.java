...
public class IfStatement implements iStatement {
    ...
    public ProgramState execute(ProgramState state) throws MyException {
        MyiDictionary<String, Value> symbolsTable = state.getSymbolsTable().peek();
    ...
    public MyiDictionary<String, Type> typeCheck(MyiDictionary<String, Type> typesTable) throws MyException {
        ...
        this.thenStatement.typeCheck(typesTable.createDeepCopy());
        this.elseStatement.typeCheck(typesTable.createDeepCopy());
