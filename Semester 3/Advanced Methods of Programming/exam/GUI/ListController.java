...
public class ListController {
    ...
    public void initialize() {
        ...
        // added for exam
        List<MyiProceduresTable> proceduresTables = menuCreator.getProceduresTablesList();
        ...
        this.selectButton.setOnAction((ActionEvent event) -> {
            ...
            // added for exam
            MyiProceduresTable proceduresTable = proceduresTables.get(selectedIndex);

            try {
                statement.typeCheck(new MyDictionary<>());

                ProgramState state = new ProgramState(statement, proceduresTable);
