...
public class Controller {
    ...
    void conservativeGarbageCollector(List<ProgramState> programStatesList) {
        ...
        programStatesList.forEach(programState -> {programState.getHeapTable().setContent(safeGarbageCollector(getAddressFromTable(programState.getSymbolsTable().peek().getContent().values()),
