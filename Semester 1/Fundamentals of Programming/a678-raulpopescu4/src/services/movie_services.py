...
class MovieServices:
    ...
    def generate_movies_data(self):
        ...
        self.__movie_repository.add(Movie(11, "aaa", "vvv", "drama"))
        self.__movie_repository.add(Movie(31, "sss", "vvv", "drama"))
        self.__movie_repository.add(Movie(24, "ddd", "vvv", "drama"))
        self.__movie_repository.add(Movie(23, "eee", "vvv", "action"))
        self.__movie_repository.add(Movie(15, "ggg", "vvv", "comedy"))
        self.__movie_repository.add(Movie(7, "hh", "vvv", "comedy"))
        self.__movie_repository.add(Movie(99, "fff", "vvv", "drama"))
        self.__movie_repository.add(Movie(65, "jjj", "vvv", "comedy"))
        self.__movie_repository.add(Movie(45, "ooo", "vvv", "comedy"))
        self.__movie_repository.add(Movie(27, "ppp", "vvv", "comedy"))
        self.__movie_repository.add(Movie(98, "iii", "vvv", "action"))
        self.__movie_repository.add(Movie(21, "eee", "vvv", "comedy"))
        self.__movie_repository.add(Movie(49, "www", "vvv", "drama"))
        self.__movie_repository.add(Movie(82, "qqq", "vvv", "comedy"))
        self.__movie_repository.add(Movie(70, "mmm", "vvv", "action"))
        self.__movie_repository.add(Movie(36, "nnn", "vvv", "comedy"))
        self.__movie_repository.add(Movie(2, "zzz", "vvv", "comedy"))
        self.__movie_repository.add(Movie(5, "bbb", "vvv", "comedy"))
        self.__movie_repository.add(Movie(76, "yyy", "vvv", "drama"))
        self.__movie_repository.add(Movie(34, "lll", "vvv", "action"))
    ...
    def remove_movie(self, movie_id):
        ...
        movie_removed = self.__movie_repository.search(movie_id)
        self.__movie_repository.remove(movie_id)

        undo_call = Call(self.__movie_repository.add, movie_removed)
