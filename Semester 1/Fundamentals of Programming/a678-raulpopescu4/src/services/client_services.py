...
class ClientServices:
    ...
    def generate_clients_data(self):
        ...
        self.__client_repository.add(Client(1, "bbb"))
        self.__client_repository.add(Client(17, "ccc"))
        self.__client_repository.add(Client(25, "ddd"))
        self.__client_repository.add(Client(79, "eee"))
        self.__client_repository.add(Client(13, "fff"))
        self.__client_repository.add(Client(22, "ggg"))
        self.__client_repository.add(Client(5, "hhh"))
        self.__client_repository.add(Client(11, "AAA"))
        self.__client_repository.add(Client(74, "BBB"))
        self.__client_repository.add(Client(65, "CCC"))
        self.__client_repository.add(Client(51, "DDD"))
        self.__client_repository.add(Client(49, "EEE"))
        self.__client_repository.add(Client(42, "FFF"))
        self.__client_repository.add(Client(38, "GGG"))
        self.__client_repository.add(Client(34, "HHH"))
        self.__client_repository.add(Client(27, "zzz"))
        self.__client_repository.add(Client(9, "ZZZ"))
        self.__client_repository.add(Client(99, "vvv"))
        self.__client_repository.add(Client(91, "VVV"))
    ...
    def remove_client(self, client_id):
        ...
        removed_client = self.__client_repository.search(client_id)
        self.__client_repository.remove(client_id)

        undo_call = Call(self.__client_repository.add, removed_client)
