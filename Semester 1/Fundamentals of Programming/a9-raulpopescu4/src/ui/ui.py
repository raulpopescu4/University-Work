...
from src.services.undo_redo_services import UndoServiceException


class UI:
    def __init__(self, client_services, movie_services, rental_services, undo_redo_services):
    ...
    def run_program(self):
        ...
        while True:
                ...
                while True:
                    ...
                    try:
                        if user_operation_command == '1':
                            ...
                            print("Not a valid number option. Choose between 1 and 7.")
                ...
                while True:
                    ...
                    try:
                        if user_operation_command == '1':
                            ...
                            print("Not a valid number option. Choose between 1 and 9.")
                    except RepositoryException as repository_error:
                        print(str(repository_error))
                    except ValidatorException as validation_errors:
                        errors = ValidatorException.get_errors(validation_errors)
            ...
            elif user_menu_command == '5':
                self.__ui_redo()

            elif user_menu_command == '6':
                break

            else:
                print("Not a valid number option. Choose between 1 and 6.")
    ...
    def __ui_update_client(self):
        ...
        self.__client_services.update_client(client_id, client_name)
    ...
    def __ui_add_movie(self):
        ...
        self.__movie_services.add_movie(movie_id, movie_title, movie_description, movie_genre)
    ...
    def __ui_remove_movie(self):
        ...
        try:
            ...
            print("Movie ID must be an integer!")
            return
        self.__movie_services.remove_movie(movie_id)
    ...
    def __ui_update_movie(self):
        ...
        self.__movie_services.update_movie(movie_id, movie_title, movie_description, movie_genre)
    ...
    def __ui_redo(self):
        try:
            self.__undo_redo_services.redo()
            print("Operation successfully redone!")
        except UndoServiceException as undo_exception:
            print(str(undo_exception))
        except RepositoryException:
            print("No more redo!")

    def __ui_undo(self):
        try:
            self.__undo_redo_services.undo()
