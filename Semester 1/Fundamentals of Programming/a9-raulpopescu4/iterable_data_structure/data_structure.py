...
class IterableDataStructure:
    ...
    @staticmethod
    def gnome_sort(object_sort, key=None, comparison_function=None, reverse_order=False):
        def default_key(obj):
            return obj
        ...
        sorted_object = deepcopy(object_sort)
        ...
        if reverse_order:
            ...
            while left_iteration_index < right_iteration_index:
                sorted_object[left_iteration_index], sorted_object[right_iteration_index] = sorted_object[right_iteration_index], sorted_object[left_iteration_index]
